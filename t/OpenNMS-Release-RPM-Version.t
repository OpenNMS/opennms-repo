...
my $two_oh_one     = OpenNMS::Release::RPM::Version->new('2.0', '1');
my $two_oh_two     = OpenNMS::Release::RPM::Version->new('2.0', '2');
my $two_oh_one_one = OpenNMS::Release::RPM::Version->new('2.0.1', '1');
...
my $release = OpenNMS::Release::RPM::Version->new('1.9.93', '1');
my $beta    = OpenNMS::Release::RPM::Version->new('1.9.93', '0.20111220.1');
my $beta2   = OpenNMS::Release::RPM::Version->new('1.9.93', '0.20111220.2');
