 ...
 */
package org.opennms.repo.api.rpm;

import java.util.Comparator;

/**
 * Implement the rpmvercmp function provided by librpm in Java. The comparator
 * operates on two strings that represent an RPM version or release.
 *
 * <p>
 * This comparator is not perfectly antysymmetric for unequal versions, but
 * close enough to warrant being a comparator. For examples of asymmetry, check
 * the test.
 */
