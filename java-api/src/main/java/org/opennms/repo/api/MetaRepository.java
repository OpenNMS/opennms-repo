...
public interface MetaRepository extends Repository {
	/**
	 * Add packages to the specified sub-repository from the given source
	 * repository. The sub-repository must also exist on the source repository.
	 * 
	 * @param subrepo
	 *            the sub-repository name
	 * @param source
	 *            the source repository to copy from
	 */
